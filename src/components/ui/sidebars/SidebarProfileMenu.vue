<template>
  <div class="flex items-center">
    <button
      ...
      class="flex items-center justify-center w-14 h-14 min-w-14 min-h-14 max-w-14 max-h-14 rounded-sm ring-2 p-0.5 transition-transform hover:scale-105 overflow-hidden bg-primary-600 text-white font-bold text-lg"
    >
  ...
  <div
    ...
    class="absolute left-full bottom-4 mb-0 ml-2 w-40 rounded-lg bg-white dark:bg-gray-800 shadow-lg py-1 transform transition-all duration-200 z-50"
  >
    <div class="relative">
      <button
        v-for="item in items"
