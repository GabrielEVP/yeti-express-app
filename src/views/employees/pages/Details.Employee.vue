        ...
        <div class="md:col-span-8 space-y-6">
          ...
          <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-2 lg:p-8">
            <ActivityView title="Ultima Actualización">
              <div class="text-2xl font-bold">{{ formatDateShort(employee.updatedAt) }}</div>
              <p class="text-xs text-gray-500">{{ formatRelativeDate(employee.updatedAt) }}</p>
            </ActivityView>
            <ActivityView title="Creación del empleado">
              <div class="text-2xl font-bold">{{ formatDateShort(employee.createdAt) }}</div>
              <p class="text-xs text-gray-500">{{ formatRelativeDate(employee.createdAt) }}</p>
            </ActivityView>
          </div>
        </div>
