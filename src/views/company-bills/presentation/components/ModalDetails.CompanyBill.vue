<template>
  <Modal :is-open="isOpen" @close="handleCloseModal">
    ...
    <div
      v-else
      class="bg-white dark:bg-gray-900 rounded-2xl shadow-xl max-w-2xl mx-auto overflow-hidden"
    >
      <!-- Header -->
      ...
      <div class="px-8 py-6 space-y-6">
        ...
        <div class="text-center py-4">
          ...
          <p class="text-3xl font-bold text-gray-900 dark:text-white">
            {{ formatToDollars(bill.getAmount()) }}
          </p>
        </div>
        ...
        <div class="space-y-4">
          <div
            class="flex justify-between items-center py-3 border-b border-gray-50 dark:border-gray-800"
          >
