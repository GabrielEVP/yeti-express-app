<template>
  <SideBar>
    ...
    <TableDashboard
<<<<<<< HEAD:src/views/clients/presentation/pages/debt/List.Debt.Client.vue
...
=======
      :headers="[...TABLE_HEADER_DEBT]"
>>>>>>> 3b3e9a1 (Remove client delivery debt functionality):src/views/debts-payments/presentation/pages/List.Debt.vue
...
>>>>>>> a424d06 (Refactor TypeScript props using type annotations):src/views/clients/presentation/pages/debt/List.Debt.Client.vue
=======
import { TABLE_HEADER_DEBT } from '@/views/debts/presentation/constants/TableHeader.Debt';
>>>>>>> 3b3e9a1 (Remove client delivery debt functionality):src/views/debts-payments/presentation/pages/List.Debt.vue
...
const handlePayment = (clientId: string, deliveryId: string, type: string) => {
