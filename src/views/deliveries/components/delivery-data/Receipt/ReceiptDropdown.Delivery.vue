<template>
   <Dropdown>
      ...
      <template #data>
         <div v-if="receipt" class="space-y-3">
               ...
               <div class="flex justify-between items-start">
                  <div class="space-y-1 text-sm">
                     ...
                     <p>
                        ...
                        {{ receipt.municipality ? receipt.municipality + ", " : "" }}
                        <span class="font-medium">Ciudad:</span> {{ receipt.city }}, <span class="font-medium">Estado:</span> {{ receipt.state }}
                     </p>
                     <p><span class="font-medium">Código Postal:</span> {{ receipt.postalCode }}</p>
                  </div>
               </div>
            </div>
         </div>
...
import type { DeliveryReceipt } from "@/views/deliveries";
