      ...
      <div class="flex justify-center items-center min-h-screen">
         <Card class="w-full max-w-4xl mx-auto p-6">
            <form @submit.prevent="onSubmit" class="h-full">
               <h2 class="text-xl font-semibold text-gray-900 dark:text-white border-b pb-2 mb-4">Editar tu usuario</h2>
               <div class="grid justify-center gap-6">
                  <InputFile type="file" acceptFormat="solo se aceptan .jpg .png .jpeg" id="profile_image" @change="handleFileChange" />
               </div>
...
import { SideBar, Card, FieldForm, InputFile, AcceptButton, CancelButton, DangerAlert } from "@/components/";
