...
import Buttondropdown from './component/Buttondropdown.vue';
import { Text, Bagde } from '@components';
import ButtonPaid from './component/ButtonPaid.vue';
import Buttonpartial from './component/buttonpartial.vue';
