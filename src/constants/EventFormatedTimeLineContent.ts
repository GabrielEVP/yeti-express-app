...
import { COURIER_EVENT_DEFINITION } from "@/views/couriers/constants/Courier.FormatedTimeLine";

export const EVENT_TIME_LINE_CONTENT: Record<string, Record<string, Omit<TimeLineContent, "date">>> = {
